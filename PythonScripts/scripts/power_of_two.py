...
"""
Checks if a Texture is a power of two texture.
"""
...
for asset in selected_assets:
    ...
    try:
        ...
        if not is_x_valid or not is_y_valid:
            unreal.log_warning("{} is not power of two ({}, {})".format(asset_name, x_size, y_size))
            unreal.log_warning("It's path is {}".format(asset_path))
            not_pow += 1
