...
#include "QuestSchemaNode_Sequence.generated.h"

class UQuestSchemaTransitionWithCheck;

/**
 * Checks all transitions and running all matching transition.
 */
UCLASS()
class QUESTSYSTEM_API UQuestSchemaNode_Sequence : public UQuestSchemaNode_Base
{
	GENERATED_BODY()

public:
	static UQuestSchemaNode_Sequence* CreateNode(UQuestSchema* OwningSchema);
